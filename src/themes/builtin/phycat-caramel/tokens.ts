...
// Ported from `phycat.light.css` + `phycat.caramel.css` in the Phycat Typora
...
// single hue applied to an otherwise fixed design, and Caramel is the amber one.
//
// That fixed part is shared verbatim with phycat-mauve; only the ramp, the
